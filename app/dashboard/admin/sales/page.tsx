...
import { DollarSign, TrendingUp, Users, ArrowUpRight, BarChart3 } from "lucide-react";
...
export default function AdminSalesPage() {
    ...
    if (loading) return <div className="p-8">Loading sales data...</div>;
    ...
    const processChartData = (transactions: Transaction[] | undefined) => {
        ...
        // Convert to array and reverse to show chronological order (since transactions are sorted desc)
    ...
    return (
        <div className="flex flex-col gap-6">
            <div>
                ...
                <p className="text-muted-foreground">Overview of subscription sales and recruiter transactions.</p>
            </div>
                                ...
                                <TableRow key={t.id} className="hover:bg-muted/30 transition-colors">
                                    ...
                                    <TableCell>
                                        <div className="flex flex-col">
                                            <span className="text-sm font-medium">{t.planName || t.packName || "Standard"}</span>
                                        ...
                                        <div className="flex flex-col gap-1 items-start">
                                            <Badge 
                                                ...
                                                className={cn(
                                                    ...
                                                    t.paymentMethod === "qr_manual" ? "bg-amber-500/10 text-amber-600" : "bg-blue-500/10 text-blue-600"
                                                )}
                                            >
