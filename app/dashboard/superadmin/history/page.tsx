  ...
  return (
    <RoleGuard allowedRoles={['superadmin']}>
      <div className="flex flex-col gap-8 max-w-7xl mx-auto pb-10">
        <div>
          <Link href="/dashboard/superadmin" className="text-sm text-muted-foreground flex items-center gap-2 mb-4 hover:text-primary transition-colors">
          ...
          <p className="text-muted-foreground mt-2">Comprehensive record of all successful hires and agency partnerships across the platform.</p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card className="border-border/60 shadow-sm">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-emerald-600">{totalDeployments}</div>
            </CardContent>
          </Card>
          <Card className="border-border/60 shadow-sm">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Card className="border-border/60 shadow-sm">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-blue-600">{individualHires}</div>
            </CardContent>
          </Card>
        </div>
                ...
                <TableBody>
                  {filteredRequests.map((req) => (
                    <TableRow key={req.id}>
                      ...
                      <TableCell>
                        <Badge variant="outline" className={req.isBulk ? "bg-purple-500/10 text-purple-600 border-purple-500/20" : "bg-blue-500/10 text-blue-600 border-blue-500/20"}>
